	...
	theme: {
		extend: {
			...
			colors: {
				...
				button: '#006bb8',
				primary: '#f2f5f7',
				'transparent-b-10': 'rgba(255, 255, 255, 0.1)',
				'transparent-b-30': 'rgba(255, 255, 255, 0.3)',
				'transparent-b-40': 'rgba(255, 255, 255, 0.4)',
				'transparent-b-50': 'rgba(255, 255, 255, 0.5)',
				'transparent-b-75': 'rgba(255, 255, 255, 0.75)',
			},
			scale: {
				120: '1.2',
				160: '1.6',
